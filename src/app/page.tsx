  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-zinc-100">
      <section className="relative overflow-hidden border-b border-zinc-800 bg-[#0a0a0a]">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 gap-8 px-5 pb-24 pt-16 sm:px-6 sm:pb-28 sm:pt-20 lg:grid-cols-2 lg:items-stretch lg:gap-12 lg:py-24">
        ...
        <div className="absolute inset-x-5 bottom-5 z-20 sm:inset-x-6 sm:bottom-6 lg:hidden">
          <OwnershipPills active="membership" />
        </div>
      </section>
