    ...
    <main className="min-h-screen bg-[#0a0a0a] text-zinc-100">
      ...
      <section className="mx-auto max-w-7xl px-5 pb-8 pt-14 sm:px-6 sm:py-10">
        ...
        <div className="max-w-5xl rounded-2xl border border-zinc-800 bg-[#111] p-4 shadow-sm sm:p-6">
          ...
          <p className="mb-5 text-lg font-medium text-zinc-200">Source a specific vehicle — allow 1-2 business days for cash/financing deals. 7-10 business days for no credit sourcing.</p>
